...
# Enrollment model
# <HINT> Once a user enrolled a class, an enrollment entry 
# should be created between the user and course
...
#  <HINT> Create a Choice Model with:
    ...
    # One-To-Many (or Many-To-Many if you want to reuse choices)
...
class Choice(models.Model):
    ...
    # Choice content
    choice_text = models.CharField(max_length=100, default="None" )
